...
func die():
	...
	$Confetti.color = $ColorRect.color
	$Confetti.scale_amount -= 0.1
	$Tween.interpolate_property($Confetti, "rotation", rotation, -PI + randf()*2*PI, time_rotate, Tween.TRANS_QUAD, Tween.EASE_IN_OUT)
	$Tween.interpolate_property($Confetti, "color:a", $Confetti.color.a, 0, time_a, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.interpolate_property($Confetti, "color:s", $Confetti.color.s, 0, time_s, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.interpolate_property($Confetti, "color:v", $Confetti.color.v, 0, time_v, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.start()
